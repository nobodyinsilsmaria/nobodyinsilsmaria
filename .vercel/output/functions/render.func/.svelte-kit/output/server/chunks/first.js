...
const First_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"max-w border-1 rounded overflow-hidden shadow-lg"}"><div class="${"px-6 py-4"}"><p class="${"text-gray-700 text-base"}">${validate_component(First, "First").$$render($$result, {}, {}, {})}</p></div>
